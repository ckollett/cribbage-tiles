...
function getTrays(deal) {
    ...
    trays.push(new SortOrderTray(deal, 'player_hand', 0, {'clickTo':'crib_selection', 'reverseZIndex':true}));
    ...
    trays.push(new SortOrderTray(deal, 'opponent_hand', 2, {'flipped':true, 'reverseZIndex':true}));
